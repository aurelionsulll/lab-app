      ...
      <div class="card">
        <div class="card-body">
          <div class="d-md-flex align-items-center">
            <div>
              <h4 class="card-title">Les activités</h4>
            </div>
            <div class="ml-auto">
              <div class="dl">
                ...
                <div
                  class="modal fade"
                  id="exampleeModalLong"
                  tabindex="-1"
                  role="dialog"
                  aria-labelledby="exampleeModalLongTitle"
                  aria-hidden="true"
                >
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleeModalLongTitle" v-show="this.editmode">
                          Edit activity
                          <br />
                          <span
          ...
          <table class="table v-middle">
            ...
            <tbody>
              <tr v-for="slider in sliders" :key="slider.id">
                ...
                <td>
                  <p class="inner-wrapper">{{slider.subtext}}</p>
                </td>
                <td>
  ...
  methods: {
    ...
    deleteSlider(id) {
      Swal.fire({
        ...
        if (result.value) {
          this.form.delete("/about_deleteSlider/" + id);
        }
      });
    },
    ...
    loadSliders() {
      axios.get("/about_show").then(({ data }) => (this.sliders = data));
    }
  }
};
</script>
