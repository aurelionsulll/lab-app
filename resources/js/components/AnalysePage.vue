                                            ...
                                            >
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Analyse icon</label>
                                                        <input v-model="form.icon" type="text" name="icon" class="form-control" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Analyse name</label>
                                                        <input v-model="form.name" type="text" name="name" class="form-control" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Analyse description</label>
                                                        <input v-model="form.desc" type="text" name="desc" class="form-control" />
                                                    </div>
                                                </div>
                ...
                <div class="table-responsive">
                    <table class="table v-middle">
                        ...
                        <tr v-for="slider in sliders" :key="slider.id">
                            <td><i :class="slider.icon" style="font-size:20px"></i></td>
                            <td>{{slider.name}}</td>
                            <td>{{slider.desc}}</td>
                            <td>
        ...
        methods: {
            ...
            deleteSlider(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.form.delete("/analyse_deleteSlider/" + id);
                    }
                });
            },
            ...
            loadSliders() {
                axios.get("/analyse_show").then(({ data }) => (this.sliders = data));
            }
        }
    };
</script>
