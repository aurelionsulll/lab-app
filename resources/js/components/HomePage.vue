      ...
      <div class="card">
        <div class="card-body">
          <div class="d-md-flex align-items-center">
            <div>
              ...
              <h5 class="card-subtitle">Téléchargez votre image</h5>
            </div>
            <div class="ml-auto">
              <div class="dl">
                <button type="button" class="btn btn-primary" @click="newModal()">Add new</button>
                <div
                  class="modal fade"
                  id="exampleModalLong"
                  tabindex="-1"
        ...
        <div class="table-responsive">
          <table class="table v-middle">
            <thead>
              <tr class="bg-light">
                <th class="border-top-0">Main texte</th>
                  <th class="border-top-0">Sub texte</th>
    ...
    toast.addEventListener('mouseleave', Swal.resumeTimer)
        ...
        export default {
            ...
            methods: {
                upd() {
                this.$Progress.start();
                this.form.post("/upd/" + this.form.id)
                    .then(() => {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                    this.form.delete("/deleteSlider/" + id);
                ...
                loadSliders() {
                axios.get("/show").then(({ data }) => (this.sliders = data));
                }
            }
        };
</script>
