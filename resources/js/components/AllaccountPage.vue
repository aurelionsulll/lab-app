            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    ...
                    >
                        ...
                        <vxe-table-column  title="Nom de société" field="user.name" width="169" sortable>
                            <template v-slot="{ row }" >
                                <span class="badge badge-pill badge-info p-2 text-white" style="">{{row.user.name}}</span>
                            </template>
                        </vxe-table-column>
                        ...
                        <vxe-table-column type="html" width="329" field="adresse" title="Adresse" sortable ></vxe-table-column>
                        <vxe-table-column type="html" width="199" field="mail" title="Email" sortable ></vxe-table-column>
                        <vxe-table-column type="html" width="183" field="pos" title="Lieu de prélèvement" sortable ></vxe-table-column>
                        ...
                        <vxe-table-column type="html" width="169" field="patient_type" title="Type de patient" sortable ></vxe-table-column>
                        <vxe-table-column type="html" width="185" field="voyageur" title="Voyageur" sortable ></vxe-table-column>
                        <vxe-table-column  title="Date de voyage" field="date_voyage" width="169" sortable>
                            <template v-slot="{ row }">
                                <span>{{ row.date_voyage | moment('DD-MM-YYYY, h:mm') }}</span>
                            </template>
                        </vxe-table-column>
                        <vxe-table-column type="html" width="169" field="resultat" title="Résultat" sortable ></vxe-table-column>
...
<script>
    ...
    export default {
        computed: {
            list () {
              ...
              if (filterName) {
                ...
                const searchProps = ['last_name', 'first_name','sexe','cin','date','tel','adresse','mail','pos','date_test','patient_type','date_voyage','voyageur','resultat']
        ...
        methods: {
            ...
            indexAccountList() {
                axios.get("/indexAllAccount").then(({ data }) => (this.userDatas = data));
            },
